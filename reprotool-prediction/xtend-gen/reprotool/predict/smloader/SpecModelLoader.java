  ...
  public void saveDomainModel(final Specification specModel, final String outFileName) {
    ...
    final Procedure1<EPackage> _function = new Procedure1<EPackage>() {
      public void apply(final EPackage it) {
        ...
        it.setNsPrefix(_name);
        String _name_1 = it.getName();
        it.setNsURI(_name_1);
      }
    };
    ObjectExtensions.<EPackage>operator_doubleArrow(_modelPackage, _function);
    XMIResourceImpl _xMIResourceImpl = new XMIResourceImpl();
    final Procedure1<XMIResourceImpl> _function_1 = new Procedure1<XMIResourceImpl>() {
      public void apply(final XMIResourceImpl it) {
        try {
          EList<EObject> _contents = it.getContents();
          DomainModel _domainModel = specModel.getDomainModel();
    ...
    ObjectExtensions.<XMIResourceImpl>operator_doubleArrow(_xMIResourceImpl, _function_1);
  }
