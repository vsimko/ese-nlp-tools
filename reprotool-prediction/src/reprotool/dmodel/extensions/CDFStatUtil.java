...
public class CDFStatUtil {
	...
	public static double getInvCDF(double d, boolean highPrecision) {
		...
		// Rational approximation for central region:
			...
			double q = d - 0.5D;
			double r = q * q;
			z = (((((ICDF_A[0] * r + ICDF_A[1]) * r + ICDF_A[2]) * r + ICDF_A[3])
					* r + ICDF_A[4])
					* r + ICDF_A[5])
					* q
	...
	private static final double X_MAX = Math.min(X_INF,
			(1 / (Math.sqrt(Math.PI) * X_MIN)));
	...
	/* ****************************************************
	 * Refining algorithm is based on Halley rational method for finding roots of
	 * equations as described at:
	 * http://www.math.uio.no/~jacklam/notes/invnorm/index.html by: Peter John
